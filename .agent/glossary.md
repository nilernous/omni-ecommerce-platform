# OmniCommerce System Glossary & Technical Lexicon

> **Target File:** `.agent/glossary.md`  
> **Source:** [GLOSSARY.md](../docs/01-overview/GLOSSARY.md)  
> **Purpose:** Agent reference guide for system terminology, domain concepts, architectural patterns, technical acronyms, and component naming standards across the OmniCommerce monorepo.  
> **Version:** 1.0.0  
...
| Document Type | System Glossary & Technical Lexicon for AI Agents |
| Scope | Platform-Wide (Domain Concepts, Architecture, Microservices, Infrastructure, Security) |
| Related Agent Files | [context.md](./context.md), [technology-stack.md](./technology-stack.md), [project-map.md](./project-map.md) |
| Core Specs | [GLOSSARY.md](../docs/01-overview/GLOSSARY.md), [SYSTEM_ARCHITECTURE.md](../docs/01-overview/SYSTEM_ARCHITECTURE.md), [TECHNOLOGY_STACK.md](../docs/01-overview/TECHNOLOGY_STACK.md) |
...
This glossary provides a comprehensive technical dictionary and domain lexicon for the **OmniCommerce** enterprise e-commerce platform.

AI Agents operating within this codebase MUST use these standardized terms, abbreviations, architectural patterns, technology names, component boundaries, and domain concepts across code modifications, PRs, comments, documentation, and agent reasoning.
...
A design pattern used in distributed systems to detect failures and prevent cascading failures by temporarily blocking calls to an unresponsive downstream or third-party service.
...
- [GLOSSARY.md](../docs/01-overview/GLOSSARY.md) - System Architecture Lexicon & Glossary
- [SYSTEM_ARCHITECTURE.md](../docs/01-overview/SYSTEM_ARCHITECTURE.md) - System Architecture Document
- [TECHNOLOGY_STACK.md](../docs/01-overview/TECHNOLOGY_STACK.md) - Approved Technology Stack & Governance
- [ARCHITECTURE_PRINCIPLES.md](../docs/01-overview/ARCHITECTURE_PRINCIPLES.md) - Architecture Principles & Standards
- [BACKEND_ARCHITECTURE.md](../docs/02-architecture-details/BACKEND_ARCHITECTURE.md) - Microservices Architecture
- [FRONTEND_ARCHITECTURE.md](../docs/02-architecture-details/FRONTEND_ARCHITECTURE.md) - Web Presentation Architecture
- [MICROFRONTEND_ARCHITECTURE.md](../docs/02-architecture-details/MICROFRONTEND_ARCHITECTURE.md) - Module Federation Architecture
